...
<head>
    ...
    <title>JHS Login | DWCU Portal</title>
...
<body class="h-full flex items-center justify-center relative overflow-hidden p-5
    ...
    <div class="relative z-10 flex overflow-hidden
        ...
        <div class="text-white flex flex-col justify-center
            ...
            <p class="font-semibold text-base mb-8" style="color:#94a3b8;">JHS Student Portal</p>
            ...
            <form method="POST" action="{{ route('jhs.login.post') }}">
                @csrf
                ...
                <div class="mb-5">
                    ...
                    <div class="input-wrapper flex items-center rounded-[12px] border"
                        ...
                        <input type="password" name="password" id="jhsPassword"
                               placeholder="Enter your password" required
                               class="bg-transparent border-none text-white w-full outline-none py-5 px-4"
                               style="font-size:1rem;font-family:'Afacad',sans-serif;">
                        <button type="button" id="toggleJhsPw" aria-label="Show password"
                ...
                <div class="flex items-center gap-2 mt-1">
                    <input type="checkbox" name="remember" id="remember-jhs"
                           class="w-4 h-4 cursor-pointer" style="accent-color:#adff2f;">
                    <label for="remember-jhs" class="text-sm cursor-pointer select-none"
        ...
        <div class="logo-section flex items-center justify-center max-[768px]:py-8"
            ...
            <div class="flex flex-col items-center text-center gap-4">
                ...
                <span class="inline-flex items-center gap-2 rounded-full px-4 py-1.5 font-bold tracking-widest uppercase"
                    ...
                    <i class="fas fa-graduation-cap"></i> JHS Student Portal
                </span>
    ...
    <script>
        ...
        const toggleBtn = document.getElementById('toggleJhsPw');
        const pwInput   = document.getElementById('jhsPassword');
