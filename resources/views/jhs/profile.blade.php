...
<head>
    ...
    <title>JHS Student Profile | DWCU Portal</title>
...
<main class="content-area">
    ...
    <div class="scroll-container">
            ...
            <div class="user-meta">
                <div class="avatar-wrapper" style="position:relative; cursor:pointer;" id="avatarWrapper">
                    <div class="avatar-circle" id="profileDisplay">
                        <i class="fas fa-user" id="defaultIcon" style="font-size:3rem; color:#666;"></i>
                    </div>
                    <div style="position:absolute; bottom:0; right:0; background:#1e2f7a; color:white; width:30px; height:30px; border-radius:50%; display:flex; align-items:center; justify-content:center; border:2px solid white;">
                ...
                <div class="user-details">
                    ...
                    <div class="banner-badges">
                        <span class="banner-badge"><i class="fas fa-layer-group"></i> Grade {{ $student->grade_level }}</span>
        ...
        <section class="info-card">
            ...
            <form id="profileForm" method="POST" action="{{ route('jhs.profile.update') }}">
                @csrf
                @method('PATCH')
                <div class="info-grid">
        ...
        <section class="info-card" style="margin-top:28px;">
            ...
            <form id="passwordForm" method="POST" action="{{ route('jhs.profile.password') }}"
...
<div id="passwordModal" style="display:none; position:fixed; inset:0; z-index:9999; align-items:center; justify-content:center;">
    ...
    <div style="position:relative; background:#fff; border-radius:24px; padding:40px 36px 32px; max-width:400px; width:90%; box-shadow:0 24px 60px rgba(13,27,68,0.22); text-align:center; animation:modalPop 0.35s cubic-bezier(.34,1.56,.64,1) both;">
        <div style="width:68px; height:68px; background:linear-gradient(135deg,#1e2f7a,#0d1b44); border-radius:20px; display:flex; align-items:center; justify-content:center; margin:0 auto 20px; box-shadow:0 8px 24px rgba(30,47,122,0.3);">
            <i class="fas fa-shield-alt" style="font-size:1.6rem; color:#adff2f;"></i>
        </div>
        ...
        <button onclick="document.getElementById('passwordModal').style.display='none'"
                style="background:linear-gradient(135deg,#1e2f7a,#0d1b44); color:#adff2f; border:none; padding:12px 32px; border-radius:12px; font-family:'Afacad',sans-serif; font-weight:700; font-size:0.95rem; cursor:pointer;">
            Got it
        </button>
    </div>
</div>
