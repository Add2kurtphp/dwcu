...
@section('content')
    ...
    <section class="bg-[#f4f4f4] py-8 md:py-16 flex justify-center min-h-[200px] md:min-h-[400px] items-center">
        <img src="{{ asset('image/dwcumain.png') }}" alt="DWCU Main Logo" class="w-full max-w-[1450px] mx-auto block" />
    </section>

    {{-- ── ABOUT ── --}}
    <section class="py-12 px-4 md:py-24 md:px-[10%] bg-[#f5f6f8] text-center" id="about-section" style="scroll-margin-top: 100px;">
        <h1 class="text-[34px] md:text-[58px] font-black text-[#1e2f7a] uppercase mb-2 leading-tight">ABOUT OUR SCHOOL</h1>
        <p class="text-[#333] text-base md:text-xl font-semibold mb-10 md:mb-20">
        ...
        <div class="flex flex-col gap-10 md:gap-16">
            ...
            <div class="flex items-center gap-8 md:gap-12 text-left flex-col md:flex-row">
            ...
            <div class="flex items-center gap-8 md:gap-12 text-left flex-col-reverse md:flex-row-reverse">
                <div class="flex-1 w-full">
    ...
    <section class="py-10 px-4 md:py-20 md:px-[10%] text-center bg-white" id="gallery-section">
        <span class="uppercase tracking-[3px] font-bold text-[#1e2f7a] block mb-2.5 text-sm">Gallery &amp; Media</span>
        <h2 class="gallery-title text-[36px] md:text-[64px] font-black text-[#1e2f7a] uppercase mb-12 md:mb-16 leading-tight"
        ...
        <div class="gallery-grid grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-5 mt-4">
            @for ($i = 1; $i <= 8; $i++)
                <img src="{{ asset('image/gallery' . $i . '.jpg') }}" alt="Moment {{ $i }}"
                     class="w-full h-[160px] md:h-[250px] object-cover rounded-[12px] md:rounded-[15px] cursor-pointer" />
            @endfor
        </div>
    </section>
    ...
    <div class="bg-[#1b2a6f] text-white py-12 md:py-20 px-5 text-center font-serif italic font-semibold">
        <h2 class="text-lg md:text-3xl leading-relaxed">"Witness to the World of Hope: Forming Lives of Integrity"</h2>
    </div>
    ...
    <section class="pt-10 md:pt-20 bg-white" id="location-section" style="scroll-margin-top: 100px;">
        ...
        <div class="relative w-full h-[550px] max-md:h-auto max-md:flex max-md:flex-col">
            <iframe
