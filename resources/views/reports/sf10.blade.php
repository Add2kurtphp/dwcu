...
<head>
    ...
    <style>
        ...
        .promotion-box {
            margin-top: 18px; padding: 10px 14px; border: 1px solid #333;
...
<div class="sheet">
    ...
    <div class="promotion-box">
        Status: {{ ($average ?? 0) >= 75 ? 'PROMOTED to the next grade level' : 'RETAINED in the current grade level' }}
    </div>

    <table class="sig-table">
        <tr>
            <td><div class="sig-line">Class Adviser</div></td>
            <td><div class="sig-line">School Registrar</div></td>
