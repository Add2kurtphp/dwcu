...
class QuizController extends Controller
{
    public function index()
    {
        ...
        return view('jhs.quizzes', compact('quizzes', 'submissions'));
    }
    ...
    public function show(Quiz $quiz)
    {
        ...
        if ($existing) {
            return redirect()->route('jhs.quizzes')->with('error', 'You already submitted this quiz.');
        }

        $quiz->load('questions');

        return view('jhs.quiz-take', compact('quiz'));
    }
